...
def get_vectorstore(text_chunks):
    embeddings = OpenAIEmbeddings(model="text-embedding-ada-002", chunk_size = 1, max_retries=10, show_progress_bar=True)
...
def main():
    load_dotenv()
    st.set_page_config(page_title="Chat with Submittal",
                       page_icon=":books:")
